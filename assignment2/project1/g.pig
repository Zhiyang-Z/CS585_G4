...
-- Assuming current timestamp is 1,000,000                       --ActionTime is hour-based--> 24*90
inactive_users = FILTER latest_activity BY latest_time < (1000000 - 90*24); -- active in the last 90 days
